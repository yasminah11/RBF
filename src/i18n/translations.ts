...
export const dict = {
  ...
  ar: {
    ...
    admin: {
      ...
      settings: {
        ...
        save: "حفظ التغييرات",
        paymentPlaceholder: "إعداد بوابة الدفع قريباً"
      },
      common: {
  ...
  tr: {
    ...
    faqPage: {
      ...
      a2: "Siparişiniz kargoya verildiğinde, takip numaranızı ve teslimatınızı izlemek için bir bağlantı içeren bir onay e-postası alacaksınız.",
