      ...
      <div className="container-luxury px-4 sm:px-6 md:px-10 pb-24 -mt-4 relative z-20">
        <div className="max-w-4xl mx-auto space-y-16 animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-150 fill-mode-both">
          ...
          <div className="prose prose-invert max-w-none">
            <p className="text-foreground/80 text-base md:text-lg leading-relaxed text-center font-light mb-12">
              {t.returnRules.policyDetails}
            </p>
          </div>

          <div className="grid sm:grid-cols-2 gap-8 md:gap-12">
            
            <div className="bg-card border border-border/40 p-8 hover:border-primary/30 transition-all duration-300 group">
              ...
              <h3 className="font-display text-lg text-cream uppercase tracking-widest mb-4">
                {t.faqPage?.categories?.returns || "Returns"}
              </h3>
              <p className="text-foreground/70 text-sm leading-relaxed">
                {t.returnRules.conditionRequirements}
              </p>
            </div>
            ...
            <div className="bg-card border border-border/40 p-8 hover:border-primary/30 transition-all duration-300 group">
              ...
              <h3 className="font-display text-lg text-cream uppercase tracking-widest mb-4">
                {t.faqPage?.categories?.orders || "Exchanges"}
              </h3>
              <p className="text-foreground/70 text-sm leading-relaxed">
                {t.returnRules.exchangeConditions}
              </p>
            </div>
