...
export default function FAQ() {
  ...
  const faqs = [
    {
      category: t.faqPage.categories.orders,
      items: [
    ...
    {
      category: t.faqPage.categories.products,
      items: [
        { q: t.faqPage.q4, a: t.faqPage.a4 },
      ]
    },
    {
      category: t.faqPage.categories.orders, // Reusing categories text for shipping
      items: [
  ...
  // Flatten for easy indexing, or just use a nested map
  const flattenedFaqs = faqs.flatMap(cat => cat.items.map(item => ({ ...item, category: cat.category })));
