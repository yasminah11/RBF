      ...
      <div className="container-luxury px-4 sm:px-6 md:px-10 pb-24 -mt-8 relative z-20">
        <div className="max-w-4xl mx-auto bg-card border border-border/40 p-8 sm:p-12 md:p-16 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-150 fill-mode-both relative overflow-hidden">
          ...
          <div className="flex flex-col items-center text-center space-y-12 relative z-10">
            <div>
              <h2 className="text-2xl md:text-3xl font-display text-cream uppercase tracking-widest mb-6">Maison Royal</h2>
              ...
              <div className="flex flex-col sm:flex-row justify-center items-start gap-10 md:gap-16 text-sm md:text-base text-foreground/80 w-full">
                <div className="flex flex-col items-center gap-4 group flex-1">
                  ...
                  <div className="pt-2">
                    <h3 className="text-[10px] uppercase tracking-[0.2em] text-primary font-bold mb-2">{t.contactInfo.email}</h3>
                    <a href="mailto:clientcare@royalbrands.com" className="hover:text-primary transition-colors font-medium">clientcare@royalbrands.com</a>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center gap-4 group flex-1">
                  ...
                  <div className="pt-2">
                    <h3 className="text-[10px] uppercase tracking-[0.2em] text-primary font-bold mb-2">{t.contactInfo.phone}</h3>
                    <a href="tel:+905551234567" className="hover:text-primary transition-colors font-medium" dir="ltr">+90 (555) 123 45 67</a>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center gap-4 group flex-1">
                  ...
                  <div className="pt-2">
                    <h3 className="text-[10px] uppercase tracking-[0.2em] text-primary font-bold mb-2">{t.contactInfo.address}</h3>
                    <p className="leading-relaxed font-medium">
                      Nişantaşı, Abdi İpekçi Cd.<br />
                      Şişli / İstanbul
                    </p>
                  </div>
                </div>
            ...
            <div className="pt-10 w-full max-w-md mx-auto border-t border-primary/10">
              <h3 className="text-[10px] uppercase tracking-[0.3em] text-primary font-bold mb-6">{t.contactInfo.social}</h3>
              <div className="flex justify-center gap-6">
                <a href="#" className="w-12 h-12 border border-border flex items-center justify-center text-foreground/80 hover:text-primary hover:border-primary transition-all duration-300 group rounded-full hover:bg-primary/5 hover:shadow-gold">
