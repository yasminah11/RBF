...
import { LayoutDashboard, ShoppingBag, ShoppingCart, Tag, Settings, LogOut } from "lucide-react";
import { cn } from "@/lib/utils";
import { supabase } from "@/integrations/supabase/client";
import { useI18n } from "@/i18n/I18nContext";

export function AdminSidebar({ mobileOpen, setMobileOpen }: { mobileOpen: boolean; setMobileOpen: (o: boolean) => void }) {
    ...
    <>
      ...
      <aside className={sidebarClasses}>
        <div className="p-6 border-b border-border">
          <h2 className="font-display text-xl text-primary tracking-wider leading-tight">ROYAL BRANDS</h2>
          <p className="text-xs text-muted-foreground uppercase tracking-widest mt-1">{t.admin.sidebar.portal}</p>
        </div>
