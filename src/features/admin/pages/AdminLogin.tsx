...
export function AdminLogin() {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md shadow-2xl border-border bg-card/50 backdrop-blur-xl relative z-10">
        <CardHeader className="space-y-2 text-center pb-8 border-b border-border/50">
          <CardTitle className="font-display text-4xl text-primary tracking-[0.1em]">ROYAL BRANDS</CardTitle>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="bg-background border-border h-12 focus:ring-primary"
              />
            </div>
            <div className="space-y-2">
            ...
            <Button type="submit" className="w-full h-12 bg-primary text-primary-foreground hover:bg-primary/90 shadow-gold font-bold uppercase tracking-widest text-xs" disabled={loading}>
